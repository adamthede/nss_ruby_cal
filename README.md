...
Printing Years (due 4/23):
==========

The second milestone of this assignment is to implement the printing of an entire year via the below command-line argument:

`> ruby cal.rb 2012`

and outputs the calendar for that year (2012):
...
This is functionally equivalent to calling Unix cal with those arguments (cal 2012) and the output of your program should match that of Unix cal.
